    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            <div class="form-group">
                ...
                <router-link to="/invoice_new/create" class="btn btn-primary">
                    New Invoice
                </router-link>
...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        get("/api/invoice_new", to.query).then((res) => {
    ...
    methods: {
        ...
        // },
        detailsPage(item) {
            this.$router.push(`/invoice_new/${item.id}`);
        },
        setData(res) {
